...
const COLS_TOP = Object.freeze('一二三四五六七八九'.split(''))
...
function expandConfig (config) {
    ...
    // config.pieceTheme = $('#piecesUrl').val() + './images/xiangqipieces/wikimedia/{piece}.svg'
    config.pieceTheme = 'https://www.phamduytung.com/games/china_chess/img/xiangqipieces/wikimedia/{piece}.svg'
    }
    ...
    // config.boardTheme = $('#piecesUrl').val() + './images/xiangqiboard.svg'
    config.boardTheme ='https://www.phamduytung.com/games/china_chess/img/xiangqiboards/wikimedia/xiangqiboard.svg'
    }
